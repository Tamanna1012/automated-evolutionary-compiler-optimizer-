...
from evolutionary.chromosome import Chromosome, CHROMOSOME_LENGTH
...
class GeneticAlgorithmTests(unittest.TestCase):
    def test_chromosome_has_fixed_length(self):
        c = Chromosome()
        self.assertEqual(len(c.genes), CHROMOSOME_LENGTH)
